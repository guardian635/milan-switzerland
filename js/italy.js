...
const SEASON = [
  ...
  ["羅馬", "先到；多一天給天空之城＋龐貝", "2/7 週日落地，梵蒂岡休。2/8 梵蒂岡、2/9 競技場。2/10 天空之城（Civita）。2/11 梵蒂岡休館＝龐貝＋拿坡里。不要阿瑪菲。"],
...
const COMPARE = [
  ...
  ["羅馬 → 奧爾維耶托 → 天空之城", "火車約 1 時 15 分＋計程車／巴士約 45 分", "開車約 1 時 50 分；六人不租車，奧爾維耶托預叫兩台計程車"],
  ["羅馬 → 龐貝／拿坡里", "Freccia 約 1 時 10 分＋Campania Express／計程車", "A1 約 2 時 15 分＋遺址停車"],
...
const BOOKINGS = [
  ...
  "現在立刻：羅馬 2/7–12 包棟（5 晚，能到 Termini）、佛羅倫斯 2/12–15（3 晚）、威尼斯 2/15–18、米蘭杜奧莫 2/18–21。",
  "約 2026/09 下旬：最後的晚餐 2/19。官方六人同一 slot。",
  "出發前 8–12 週：梵蒂岡 2/8 週一、競技場 2/9、龐貝 2/11、烏菲茲 2/13、學院 2/14。梵蒂岡不要訂 2/7、不要訂 2/11。",
  "開賣就訂：Freccia 2/11 羅馬→拿坡里（當日來回）、2/12 羅馬→佛羅倫斯、2/15 佛羅倫斯→威尼斯、2/18 威尼斯→米蘭。2/10 奧爾維耶托火車票＋天空之城計程車。",
...
const TICKETS = [
  ...
  },
  {
    ...
    when: "現在立刻",
    title: "住宿——四大兩小優先包棟",
    standard: "羅馬 5 晚＋佛羅倫斯 3＋威尼斯 3＋米蘭 3。Booking 整套房或 Airbnb。",
    premium: {
  ...
  },
  {
    ...
    must: true,
    when: "出發前 1–2 週",
    title: "天空之城 Civita　2/10",
    standard: "Termini→Orvieto 火車約 1 時 15 分。奧爾維耶托預先訂兩台計程車或 van 去 Civita（約 45 分）。步行吊橋進鎮，鎮內 2 小時夠。二月風大，穿防滑靴。冬天巴士班次少，不要賭現場。",
    premium: null
  },
  {
    id: "pompeii",
    ...
    when: "出發前 2–4 週",
    title: "龐貝＋拿坡里　2/11",
    standard: "官方 pompeiisites.org。Freccia 羅馬→拿坡里約 1 時 10 分，再 Campania Express 或計程車去遺址。上午龐貝、下午拿坡里披薩＋老城短走，傍晚 Freccia 回羅馬。不要加阿瑪菲。",
    premium: { name: "Campania Express 代替區間車", rec: true, note: "比 Circumvesuviana 乾淨準點，六人值得。" }
  },
  {
    id: "uffizi",
    must: true,
  ...
  },
  {
    ...
    standard: "2/11 羅馬⇄拿坡里當日來回、2/12 羅馬→佛羅倫斯、2/15 佛羅倫斯→威尼斯、2/18 威尼斯→米蘭。",
...
const DAYS = [
  ...
  },
  {
    ...
    rent: { yes: false, label: "不租車", reason: "火車到奧爾維耶托，再預叫計程車。六人冬天不要自己開山路。" },
    ...
    transport: {
      mode: "火車＋預叫計程車",
      detail: "Termini→Orvieto 約 1 時 15 分。奧爾維耶托到 Civita 約 45 分，六人預先訂 van 或兩台計程車往返。冬天 Cotral 巴士班次少，不要賭。鎮內只能走。",
      drive: "約 1 時 50 分。ZTL 回羅馬＋山路，不租。",
    },
    slots: [
      { t: "07:20", title: "Termini 往 Orvieto", d: "Regionale 即可。帶防滑靴、手套。二月吊橋風大。" },
      { t: "08:40", title: "奧爾維耶托接計程車", d: "不要現場攔。先看大教堂外觀 20 分也可以，但天空之城才是今天目的。" },
      { t: "10:00", title: "步行吊橋進 Civita", d: "約 300 公尺緩上坡。鎮很小，2 小時走完。門票在橋頭。" },
      { t: "12:30", title: "鎮內午餐", d: "二月部分餐廳休，先查。吃完就走，不要拖到 15:00。" },
      { t: "14:30", title: "計程車回 Orvieto、搭火車", d: "預留 30 分找月台。" },
      { t: "17:30", title: "回到 Termini", d: "以當日班次為準。" },
  ...
  },
  {
    ...
    rent: { yes: false, label: "不租車", reason: "Freccia 到拿坡里最快。遺址內只能走。" },
    ...
    transport: {
      mode: "Frecciarossa ＋ Campania Express／計程車",
      detail: "Termini→Napoli Centrale 約 1 時 10 分。再 Campania Express（建議）或計程車到 Pompei Scavi。不要坐又慢又亂的 Circumvesuviana 帶六人冬裝。傍晚 Freccia 回羅馬。",
      drive: "A1 約 2 時 15 分＋遺址停車。不划算。",
    },
    slots: [
      { t: "07:00", title: "Termini 早班 Freccia", d: "對號。帶水、帽子、防滑靴。2/11 梵蒂岡休，所以今天往南。" },
      { t: "08:15", title: "拿坡里轉 Campania Express 或計程車", d: "直達龐貝入口。六人計程車有時更快。" },
      { t: "09:15", title: "龐貝遺址", d: "官方票。家庭抓 2.5–3 小時：廣場、烘焙店、妓院、圓形劇場選一條線走，不要全城打卡。冬天約 15:30 開始趕人。" },
      { t: "12:45", title: "回拿坡里午餐", d: "中央車站附近或 Spaccanapoli 一口披薩。不要排三小時網紅店。" },
