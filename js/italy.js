...
const DAYS = [
  ...
  },
  {
    ...
    slots: [
      ...
      { t: "16:30", title: "聖馬可廣場看嘉年華", d: "今天只建立方位：廣場、鐘樓外觀、面具人。不要排總督宮。" },
      { t: "19:00", title: "晚餐後早睡", d: "時差。明天才是逛街＋島內。21:30 睡。" },
    ],
  },
  {
    n: 3,
    ...
    slots: [
      ...
      { t: "17:30", title: "大運河 vaporetto 一圈", d: "1 號線當觀光船。天約 17:40 黑。" },
      { t: "19:30", title: "晚餐", d: "明天閉幕日，早點睡。" },
    ],
  },
  {
    n: 4,
    ...
    slots: [
      ...
      { t: "15:00", title: "再看一輪盛裝", d: "這是這趟威尼斯的句點。17:00 前回公寓。" },
      { t: "18:00", title: "打包", d: "明天 vaporetto＋Freccia。大箱今晚就收，只留過夜。" },
      { t: "20:00", title: "早睡", d: "明天 09:00 前要在 S. Lucia。" },
    ],
  },
  {
    n: 5,
    ...
    slots: [
      ...
      { t: "19:00", title: "Oltrarno 晚餐", d: "Santo Spirito 一帶。明天烏菲茲早場。" },
    ],
  },
  {
    n: 6,
    ...
    slots: [
      ...
      { t: "16:30", title: "舊橋黃昏", d: "金鋪觀光價，看就好。買皮件去 Oltrarno 工坊。" },
      { t: "19:00", title: "晚餐", d: "明天學院＋逛街。" },
    ],
  },
  {
    n: 7,
    ...
    slots: [
      ...
      { t: "18:30", title: "Pitti 外觀或日落橋", d: "Pitti 若沒訂票只看廣場。明天錫耶納選配。" },
    ],
  },
  {
    n: 8,
    ...
    slots: [
      ...
      { t: "17:30", title: "回公寓打包", d: "明天 Freccia 去羅馬。英國 half-term 開始，羅馬會擠。" },
      { t: "20:00", title: "早睡", d: "明天 10:00 前要在 SMN。" },
    ],
  },
  {
    n: 9,
    ...
    slots: [
      ...
      { t: "16:00", title: "特拉斯提弗列散步", d: "情人節人多。當移動日。萬神殿可路過。" },
      { t: "19:30", title: "晚餐", d: "明天梵蒂岡早場，21:30 睡。" },
    ],
  },
  {
    n: 10,
    ...
    slots: [
      ...
      { t: "13:30", title: "午餐、回公寓", d: "這天到此。不要加競技場。" },
      { t: "16:30", title: "Prati 平價逛街（選）", d: "Via Cola di Rienzo 比西班牙階梯實用。" },
      { t: "20:00", title: "早睡", d: "明天競技場。" },
    ],
  },
  {
    n: 11,
    ...
    slots: [
      ...
      { t: "15:30", title: "回公寓休息", d: "石板路走一天。晚上可義大利菜，不要夜遊加點。" },
    ],
  },
  {
    n: 12,
    ...
    slots: [
      ...
      { t: "14:30", title: "特雷維→萬神殿", d: "特雷維人永遠多，丟幣就走。萬神殿看穹頂。" },
      { t: "16:30", title: "回公寓", d: "選配龐貝請改明天，不要今天硬加那不勒斯。" },
    ],
  },
  {
    n: 13,
    ...
    slots: [
      ...
      { t: "18:00", title: "打包", d: "明天 Freccia 羅馬→米蘭約 3 時 10 分。最後的晚餐在下午。" },
    ],
  },
  {
    n: 14,
    ...
    slots: [
      ...
      { t: "17:30", title: "迴廊＋Montenapoleone 櫥窗", d: "Galleria → Via della Spiga → Montenapoleone。這是市區逛街，不是 Outlet。" },
      { t: "19:30", title: "晚餐、早睡", d: "明天 Outlet 9:00 接駁。Navigli 若還有電再去，沒有就睡。" },
    ],
  },
  {
    n: 15,
    ...
    slots: [
      ...
      { t: "20:30", title: "睡覺", d: "不出城備案：09:30 金四角＋Corso Buenos Aires＋Rinascente，16:00 回。Fidenza 備案：09:45 Piazza Repubblica，17:00 回。" },
    ],
  },
  {
    n: 16,
