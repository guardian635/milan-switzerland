...
const TICKETS = [
  {
    ...
    must: true,
    when: "現在立刻（二月滑雪旺季）",
    title: "飯店 6 間——機票以外現在唯一必訂",
    standard: "1/31–2/3 米蘭 Duomo 3 晚、2/3–2/5 琉森 2 晚、2/5–2/7 茵特拉肯 2 晚、2/7–2/9 策馬特 2 晚、2/9–2/10 聖莫里茲 1 晚、2/10–2/12 米蘭 Centrale 2 晚。能免費取消的方案優先。",
    premium: {
      name: "策馬特／聖莫里茲窗景房",
      rec: true,
      note: "這兩晚是整趟最會賣光的。策馬特要車站步行 5 分內或馬特洪峰窗；聖莫里茲要車站步行可到（冰河列車約 15:37 到、天很快黑）。坡上很遠的房不要訂。"
    }
  },
  {
    id: "gex-ex",
